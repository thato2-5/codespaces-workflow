...
!function() {
    ...
    function B() {
        ...
        Pr(25),
        R.gap < 3e5 ? F = X(B, U) : Li && (A("clarity", "suspend"),
        eo(),
        ...
        default:
            ...
            if (u && u.length > 0)
                if (0 === e) {
                    ...
                    c in Tt || (Tt[c] = []),
                    Tt[c].indexOf(t.id) < 0 && Tt[c].push(t.id),
                    i = "".concat(c).concat("~").concat(Tt[c].indexOf(t.id))
                } else
    ...
    function Fe(t) {
        ...
        if (e && e.type && n) {
            ...
            Ue.length > 0 && Ue[Ue.length - 1].data.target === r.target && Ue.pop(),
            Ue.push({
                time: s(t),
                event: 27,
                data: r
    ...
    function xn(t) {
        ...
        t.nodeType === Node.DOCUMENT_NODE && (Ae(t),
        function(t) {
            Ti(t, "cut", Xe.bind(this, 0), !0),
            Ti(t, "copy", Xe.bind(this, 1), !0),
            Ti(t, "paste", Xe.bind(this, 2), !0)
        }(t),
        function(t) {
            Ti(t, "mousedown", Ze.bind(this, 13, t), !0),
            Ti(t, "mouseup", Ze.bind(this, 14, t), !0),
            Ti(t, "mousemove", Ze.bind(this, 12, t), !0),
            Ti(t, "wheel", Ze.bind(this, 15, t), !0),
            Ti(t, "dblclick", Ze.bind(this, 16, t), !0),
            Ti(t, "touchstart", Qe.bind(this, 17, t), !0),
            Ti(t, "touchend", Qe.bind(this, 18, t), !0),
            Ti(t, "touchmove", Qe.bind(this, 19, t), !0),
            Ti(t, "touchcancel", Qe.bind(this, 20, t), !0)
        }(t),
        function(t) {
            Ti(t, "input", Fe, !0)
        }(t),
        function(t) {
            Ti(t, "selectstart", gn.bind(this, t), !0),
            Ti(t, "selectionchange", gn.bind(this, t), !0)
        }(t),
        function(t) {
            Ti(t, "change", _e, !0)
        }(t),
    ...
    var _n = Object.freeze({
        ...
        start: function() {
            ...
            Ti(window, "resize", nn),
            nn(),
            Ti(document, "visibilitychange", Tn),
            Tn(),
            rn = [],
            sn(),
            yn(),
    ...
    function Yn() {
        ...
        Wn = 0,
        Xn = {},
        null === jn && (jn = CSSStyleSheet.prototype.insertRule,
        ...
        null === An && (An = CSSStyleSheet.prototype.deleteRule,
    ...
    function ta(t, e, n) {
        ...
        case Node.ELEMENT_NODE:
            ...
            case "IFRAME":
                ...
                T.attributes["*O"] = "true",
                N.contentDocument && N.contentWindow && "loading" !== N.contentDocument.readyState && (r = N.contentDocument)),
                ce[i](t, o, T, e);
                break;
            case "LINK":
        ...
        at(this, void 0, void 0, (function() {
            ...
            return rt(this, (function(z) {
                ...
                case 8:
                    ...
                    C = 0,
                    D = N ? ["tag", "attributes", "value"] : ["tag"]; C < D.length; C++)
                        if (O[j = D[C]])
                            switch (j) {
                            case "tag":
                                A = Ia(S),
                                R = I ? -1 : 1,
                                r.push(S.id * R),
                                S.parent && N && (r.push(S.parent),
                                S.previous && r.push(S.previous)),
                                r.push(T ? "*M" : O[j]),
                                A && 2 === A.length && r.push("".concat("#").concat(Ca(A[0]), ".").concat(Ca(A[1])));
                                break;
                            case "attributes":
                                for (L in O[j])
                                    void 0 !== O[j][L] && r.push(Da(L, O[j][L], M));
                                break;
                            case "value":
    ...
    var Sr, Er = {}, Or = new Set, Nr = {}, Tr = {}, Mr = {}, xr = {};
    function _r() {
        jr()
    }
    function Ir(t) {
            ...
            for (var t in Nr) {
                ...
                if ("" == xr[e] || document.querySelector(xr[e])) {
                    ...
                    for (var u in o) {
                        ...
                        if (s)
                            Ar(e, c, Array.from(s).map((function(t) {
    ...
    var Ui = Object.freeze({
        ...
        start: function() {
            ...
            Ut(),
            o.delayDom ? Ti(window, "load", (function() {
                Yn()
            }
            )) : Yn(),
            ...
            window.Animation && window.KeyframeEffect && window.KeyframeEffect.prototype.getKeyframes && window.KeyframeEffect.prototype.getTiming && (Na(),
            Ma(ya, "play"),
            Ma(ba, "pause"),
            Ma(wa, "cancel"),
            Ma(ka, "finish"),
    ...
    var $i = [Yi, Ui, _n, Object.freeze({
        ...
        start: function() {
            ...
            function() {
                ...
                window.PerformanceObserver && PerformanceObserver.supportedEntryTypes ? "complete" !== document.readyState ? Ti(window, "load", X.bind(this, Ki, 0)) : Ki() : kr(3, 0)
            }()
        },
        stop: function() {
            Fi && Fi.disconnect(),
