    ...
    var data = {
        "resource": {
            ...
            "tags": [{
                ...
                "vtp_conversionId": "1055501650",
                "vtp_currencyCode": "ZAR",
                "vtp_conversionLabel": "ZsOfCJj5glYQ0tqm9wM",
                "vtp_rdp": false,
                "vtp_url": ["macro", 3],
                ...
                "vtp_eventName": ["macro", 4],
                "vtp_measurementIdOverride": "G-QH4HVL4PTN",
                ...
                "function": "__html",
                "once_per_event": true,
                "vtp_html": "\u003Cscript type=\"text\/gtmscript\"\u003E(function(a,e,b,f,g,c,d){a[b]=a[b]||function(){(a[b].q=a[b].q||[]).push(arguments)};c=e.createElement(f);c.async=1;c.src=\"https:\/\/www.clarity.ms\/tag\/\"+g+\"?ref\\x3dgtm2\";d=e.getElementsByTagName(f)[0];d.parentNode.insertBefore(c,d)})(window,document,\"clarity\",\"script\",\"jqr8qrf5b4\");\u003C\/script\u003E",
...
*/
    ...
    ;function ah(a, b, c) {
        ...
        for (var f = 0; f < a.length(); f++) {
            var g = a.get(f);
            g instanceof Za && g.has(b) && g.has(c) && (d.set(g.get(b), g.get(c)),
            e = !0)
        }
        return e ? d : null
    }
    ...
    hi.se = Number("0") || 0;
    hi.jb = "dataLayer";
    hi.sn = "ChEI8MObtgYQ/dLX1ZnHge2EARIkAPs+3W42/6uP04CKTkgbgEi+BZz3kyRZmXUaGsO+rSqqRzm9GgIJag\x3d\x3d";
    var ji = {
        __cl: 1,
        __ecl: 1,
        __ehl: 1,
    ...
    ;function cz() {
        var a = [["cv", T(92) ? bz() : "10"], ["rv", hi.Xg], ["tc", kf.filter(function(b) {
            return b
        }).length]];
        ...
        (function(b) {
            ...
            if (T(18)) {
                ...
                if (b.vtp_enableCrossDomain && b.vtp_linkerDomains) {
                    var n = {};
                    m[P.g.sa] = (n[P.g.Bc] = b.vtp_acceptIncoming,
                ...
                if (!b.vtp_enableCrossDomain || b.vtp_acceptIncoming !== !1)
                    if (b.vtp_enableCrossDomain || ap())
                        cq(a, q),
                        np(q);
                $p(q);
                iq(["aw", "dc"], q);
                Hq(q, void 0, void 0, g);
                if (b.vtp_enableCrossDomain && b.vtp_linkerDomains) {
                ...
                !Di() && !qi && T(82) && jt(void 0, Math.round(Cb()));
                ur({
                    m: Ql(new Fl(b.vtp_gtmEventId,b.vtp_gtmPriorityId)),
                    jh: !1,
                    yd: g,
                    hc: q,
                    Sf: !0
        ...
        function b(f, g, k) {
            ...
            if (Ta(q)) {
                ...
                for (t in q)
                    ...
                    r = !0),
                    t === "currencyCode" ? n("currency", q.currencyCode) : t === "impressions" && g === P.g.kb ? p(q.impressions, null) : t === "promoClick" && g === P.g.Fb ? p(q.promoClick.promotions, q.promoClick.actionField, !0) : t === "promoView" && g === P.g.lb ? p(q.promoView.promotions, q.promoView.actionField, !0) : e.hasOwnProperty(t) ? g === e[t] && p(q[t].products, q[t].actionField) : m[t] = q[t]);
                h(m, k)
            }
        }
        var c = []
        ...
        (function(f) {
            ...
            if (l(g) && g.indexOf("G-") === 0) {
                ...
                if (f.vtp_eventSettingsTable) {
                    var q = GI(f.vtp_eventSettingsTable, "parameter", "parameterValue"), r;
                    for (r in q)
                        m[r] = q[r]
                }
                var t = GI(f.vtp_eventParameters, "name", "value"), u;
                for (u in t)
    ...
    function() {
        ...
        (function(b) {
            ...
            var c = !b.hasOwnProperty("vtp_enableConversionLinker") || !!b.vtp_enableConversionLinker
              ...
              , e = GI(b.vtp_customVariables, "varName", "value") || {}
              , f = {}
            ...
            g[P.g.Vb] = TI(P.g.Vb),
            g[P.g.Ja] = TI(P.g.Ja);
            b.vtp_rdp && (g[P.g.Yb] = !0);
            if (b.vtp_enableCustomParams)
                for (var k in e)
                    bi.hasOwnProperty(k) || (g[k] = e[k]);
            ...
            g[P.g.uc] = b.vtp_deliveryCountry,
            ...
            if (r) {
                var t = {};
                g[P.g.Sd] = (t[b.vtp_conversionLabel] = r,
                t)
            }
            var u = "AW-" + b.vtp_conversionId
              , v = u + "/" + b.vtp_conversionLabel;
            ew(u, b.vtp_transportUrl, {
                source: 7,
                fromContainerExecution: !0,
                siloed: !0
            });
            ...
            Bx(ux(Cj(v), P.g.Ia, g), b.vtp_gtmEventId, x)
        })
    }();
        ...
        function b(d) {
            ...
            if (H.body) {
                var f = d.vtp_gtmOnFailure
                  ...
                  , k = g.Uj
                  , m = g.onSuccess;
                if (d.vtp_useIframe) {} else if (d.vtp_supportDocumentWrite)
                    c(k, m, f);
                else {
                    var n = m;
                    n = function() {
    ...
    var YI = {};
    YI.onHtmlSuccess = Yy(!0),
    YI.onHtmlFailure = Yy(!1);
    YI.dataLayer = Ki;
