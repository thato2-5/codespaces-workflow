...
, function(e, a, t) {
    ...
    var l, i = !1, s = function() {
        ...
        o = [{
            ...
            value: function() {
                jQuery('[data-toggle="click-ripple"]:not(.js-click-ripple-enabled)').each((function(e, a) {
                    ...
                    t.addClass("js-click-ripple-enabled").css({
                        ...
                        (a = t.children(".click-ripple")).height() || a.width() || (o = Math.max(t.outerWidth(), t.outerHeight()),
                        a.css({
                            height: o,
                            width: o
                        })),
                ...
                jQuery(".js-table-sections:not(.js-table-sections-enabled)").each((function(e, a) {
                    ...
                    jQuery(".js-table-sections-header > tr", t).on("click.pixelcave.helpers", (function(e) {
                        if (!("checkbox" === e.target.type || "button" === e.target.type || "a" === e.target.tagName.toLowerCase() || jQuery(e.target).parent("a").length || jQuery(e.target).parent("button").length || jQuery(e.target).parent(".custom-control").length || jQuery(e.target).parent("label").length)) {
                            ...
                            a.hasClass("show") || jQuery("tbody", t).removeClass("show table-active"),
            ...
            value: function() {
                ...
                jQuery(".js-table-checkable:not(.js-table-checkable-enabled)").each((function(a, t) {
                    ...
                    jQuery("tbody input:checkbox, tbody input + label", o).on("click.pixelcave.helpers", (function(a) {
                        ...
                        t.prop("checked") ? jQuery("tbody input:checkbox:checked", o).length === jQuery("tbody input:checkbox", o).length && jQuery("thead input:checkbox", o).prop("checked", !0) : jQuery("thead input:checkbox", o).prop("checked", !1),
                    ...
                    jQuery("tbody > tr", o).on("click.pixelcave.helpers", (function(a) {
                        if (!("checkbox" === a.target.type || "button" === a.target.type || "a" === a.target.tagName.toLowerCase() || jQuery(a.target).parent("a").length || jQuery(a.target).parent("button").length || jQuery(a.target).parent(".custom-control").length || jQuery(a.target).parent("label").length)) {
                            ...
                            n ? jQuery("thead input:checkbox", o).prop("checked", !1) : jQuery("tbody input:checkbox:checked", o).length === jQuery("tbody input:checkbox", o).length && jQuery("thead input:checkbox", o).prop("checked", !0)
                        }
                    }
                    ))
                }
            ...
            key: "ckeditor",
            value: function() {
                jQuery("#js-ckeditor-inline:not(.js-ckeditor-inline-enabled)").length && (jQuery("#js-ckeditor-inline").attr("contenteditable", "true"),
                CKEDITOR.inline("js-ckeditor-inline"),
                jQuery("#js-ckeditor-inline").addClass("js-ckeditor-inline-enabled")),
                jQuery("#js-ckeditor:not(.js-ckeditor-enabled)").length && (CKEDITOR.replace("js-ckeditor"),
            ...
            value: function() {
                ...
                jQuery("#js-ckeditor5-classic:not(.js-ckeditor5-classic-enabled)").length && (ClassicEditor.create(document.querySelector("#js-ckeditor5-classic")).then((function(e) {
                    window.editor = e
                }
                )).catch((function(e) {
                ...
                jQuery(".js-sparkline:not(.js-sparkline-enabled)").each((function(a, t) {
                    var o = jQuery(t)
                      ...
                      , s = {
                        ...
                        pie: function() {
                            r.type = n,
                            r.sliceColors = ["#ffb119", "#8dc451", "#3c90df", "#e04f1a"],
                            r.highlightLighten = o.data("highlight-lighten") || 1.1,
                            r.tooltipFormat = "{{prefix}}{{value}}{{suffix}}"
                        },
                        tristate: function() {
                            r.type = n,
                    ...
                    s[n] ? (s[n](),
                    "line" === n && ((o.data("chart-range-min") >= 0 || o.data("chart-range-min")) && (r.chartRangeMin = o.data("chart-range-min")),
                    ...
                    jQuery(t).sparkline(o.data("points") || [0], r)) : console.log("[jQuery Sparkline JS Helper] Please add a correct type (line, bar, pie or tristate) in all your elements with 'js-sparkline' class.")
                }
                ))
            }
        }, {
            ...
            value: function(e) {
                ...
                jQuery(".js-flatpickr:not(.js-flatpickr-enabled)").each((function(e, a) {
                    var t = jQuery(a);
                    t.addClass("js-flatpickr-enabled"),
                    flatpickr(t, {})
                }
                ))
            }
    ...
    function u(e, a) {
        return (u = Object.setPrototypeOf || function(e, a) {
    ...
    function h(e, a) {
        return !a || "object" !== d(a) && "function" != typeof a ? function(e) {
            if (void 0 === e)
    ...
    var f = function(e) {
        ...
        (t = [{
            ...
            value: function(e) {
                "init" === e ? (this._lPage.addClass("side-trans-enabled"),
                this._uiHandleSidebars()) : this._lPage.hasClass("side-scroll") ? (this._lSidebar.length > 0 && !this._lSidebarScroll && (this._lSidebarScroll = new SimpleBar(this._lSidebarScrollCon[0]),
                jQuery(".simplebar-content-wrapper", this._lSidebar).scrollLock("enable")),
                this._lSideOverlay.length > 0 && !this._lSideOverlayScroll && (this._lSideOverlayScroll = new SimpleBar(this._lSideOverlay[0]),
                jQuery(".simplebar-content-wrapper", this._lSideOverlay).scrollLock("enable"))) : (this._lSidebar && this._lSidebarScroll && (jQuery(".simplebar-content-wrapper", this._lSidebar).scrollLock("disable"),
                ...
                this._lSideOverlay && this._lSideOverlayScroll && (jQuery(".simplebar-content-wrapper", this._lSideOverlay).scrollLock("disable"),
            ...
            value: function() {
                ...
                e._lPage.hasClass("page-header-glass") && e._lPage.hasClass("page-header-fixed") && jQuery(window).on("scroll.pixelcave.header", (function(a) {
            ...
            value: function() {
                ...
                this._lPage.on("click.pixelcave.menu", '[data-toggle="submenu"]', (function(e) {
                    ...
                    if (!(n.getWidth() > 991 && a.parents(".nav-main").hasClass("nav-main-horizontal nav-main-hover"))) {
                        ...
                        a.attr("aria-expanded", "false")) : (a.closest("ul").children("li").removeClass("open"),
                        t.addClass("open"),
            ...
            value: function() {
                ...
                "show" === e ? this._lpageLoader.length ? (a && this._lpageLoader.removeClass().addClass(a),
                this._lpageLoader.addClass("show")) : this._lBody.prepend('<div id="page-loader" class="show'.concat(a ? " " + a : "", '"></div>')) : "hide" === e && this._lpageLoader.length && this._lpageLoader.removeClass("show")
            }
        }, {
            key: "_uiHandleTheme",
            value: function() {
                ...
                this._lPage.on("click.pixelcave.themes", '[data-toggle="theme"]', (function(t) {
                    ...
                    n.updateTheme(e, r),
                    e = jQuery("#css-theme"),
                    a && Cookies.set("dashmixThemeName", r, {
                        expires: 7
                    }),
                    o.blur()
                }
                ...
                var t = {
                    init: function() {
                        ...
                        a._lPage.on("click.pixelcave.layout", '[data-toggle="layout"]', (function(e) {
                            ...
                            a._uiApiLayout(t.data("action")),
                            t.blur()
                        }
                        )),
                        a._lPage.hasClass("enable-page-overlay") && (a._lPage.prepend('<div id="page-overlay"></div>'),
                    ...
                    header_glass_on: function() {
                        a._lPage.addClass("page-header-glass"),
                        a._uiHandleHeader()
                    },
                    ...
                    side_scroll_toggle: function() {
                        a._lPage.toggleClass("side-scroll"),
                        a._uiHandleSidebars()
                    },
                    side_scroll_native: function() {
                        a._lPage.removeClass("side-scroll"),
                        a._uiHandleSidebars()
                    },
                    side_scroll_custom: function() {
                        a._lPage.addClass("side-scroll"),
                        a._uiHandleSidebars()
                    },
            ...
            key: "_uiApiBlocks",
            value: function() {
                var e, a, t, o = this, n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "init", r = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], l = this, i = "si si-size-fullscreen", s = "si si-size-actual", c = "si si-arrow-up", d = "si si-arrow-down", u = {
                    init: function() {
                    ...
                    fullscreen_on: function() {
                        e.removeClass("block-mode-pinned").addClass("block-mode-fullscreen"),
                    ...
                    content_toggle: function() {
                        ...
                        t.length && (e.hasClass("block-mode-hidden") ? jQuery("i", t).removeClass(c).addClass(d) : jQuery("i", t).removeClass(d).addClass(c))
                    },
                    ...
                    state_toggle: function() {
                        ...
                        jQuery('[data-toggle="block-option"][data-action="state_toggle"][data-action-mode="demo"]', e).length && setTimeout((function() {
                ...
                "init" === n ? u[n]() : (e = r instanceof jQuery ? r : jQuery(r)).length && (a = jQuery('[data-toggle="block-option"][data-action="fullscreen_toggle"]', e),
                t = jQuery('[data-toggle="block-option"][data-action="content_toggle"]', e),
                u[n] && u[n]())
            }
        }, {
            key: "init",
